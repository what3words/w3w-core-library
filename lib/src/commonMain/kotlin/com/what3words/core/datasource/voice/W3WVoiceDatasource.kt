...
interface W3WVoiceDatasource {
     ...
     * @param voiceLanguage The language used to initialize the ASR engine. Accepts instances of [W3WRFC5646Language] or [W3WProprietaryLanguage].
     ...
     * @param onResult Callback invoked when the ASR process is complete, providing a [W3WResult] instance containing a list of what3words address suggestions.
     */
    fun autosuggest(
